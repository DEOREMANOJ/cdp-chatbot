...
# Load the documentation data from files
def load_documentation():
    docs = {}
    for filename in os.listdir("documentation"):
        with open(f"documentation/{filename}", "r") as f:
            docs[filename.split(".")[0]] = f.read()
    return docs
